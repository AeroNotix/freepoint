...
#
# Created: Thu Jun 14 15:36:41 2012
...
class Ui_frm_sql_data_entry(object):
    def setupUi(self, frm_sql_data_entry):
        ...
        frm_sql_data_entry.resize(407, 246)
        ...
        self.gridLayout.addWidget(self.txt_sql_entry, 0, 2, 7, 1)
        ...
        frm_sql_data_entry.setTabOrder(self.buttonBox, self.txt_sql_entry)
